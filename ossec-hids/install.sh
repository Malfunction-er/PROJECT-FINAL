...
Install()
{
    ...
    if [ "X${USER_BINARYINSTALL}" = "X" ]; then
        ...
        # alert entry
        # Add PCRE2
        CFLAGS="-I/opt/homebrew/Cellar/pcre2/10.44/include $CFLAGS"
        LDFLAGS="-L/opt/homebrew/Cellar/pcre2/10.44/lib $LDFLAGS"

        # Add OpenSSL
        CFLAGS="-I/opt/homebrew/opt/openssl/include $CFLAGS"
        LDFLAGS="-L/opt/homebrew/opt/openssl/lib $LDFLAGS"
